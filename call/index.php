<?php
// CallALink Deep Link Redirect Handler
// File: /call/index.php
...
if ($userId && !empty($userId)) {
    ...
    $appDeepLink = "callalink.com";
    // $appDeepLink = "callalink://call?user=" . urlencode($userId);
    
    // Log the redirect attempt (optional)
    error_log("CallALink redirect: " . $userId . " -> " . $appDeepLink);
    ...
    <body>
        <div class="container">
            ...
            <div id="fallback">
                ...
                <a href="<?php echo htmlspecialchars($appDeepLink); ?>" class="btn">Open CallALink App</a>
                <br><br>
                <p><small>User ID: <span class="user-id"><?php echo htmlspecialchars($userId); ?></span></small></p>
                <p><small>If you don't have the app, please install CallALink first.</small></p>
            </div>
        </div>
    ...
    <head>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>Invalid CallALink Link</title>
        <style>
            body {
                font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;
                text-align: center;
    ...
    <body>
        <div class="container">
            ...
            <h2>Invalid CallALink Link</h2>
            <p>This CallALink link appears to be invalid or malformed.</p>
            <p>Please ask the sender to generate a new link from the CallALink app.</p>
        </div>
    </body>
    </html>
    <?php
