...
class UserController extends Controller
{
    public function __construct(
        protected CallPermissionEngine $callPermissionEngine,
        ...
        if ($user) {
            if (Hash::check($request->password, $user->password)) {
                ...
                $response = [
                    ...
                    'timezone' => $user->timezone ?? getTimeZone(),
                ];
    ...
    public function checkCallPermission(Request $request)
    {
        Log::info('checkCallPermission API called', $request->all());
        ...
        $result = $this->callPermissionEngine->evaluate(
            $request->input('caller_number')
        );
