...
function loadEventData() {
    ...
    if (currentRouteName == "events.edit") {
        ...
        if (
            !$("#slotTimeId").length ||
            !$(".startTimeSlot").length ||
            !$(".endTimeSlot").length ||
            !$("#withinDateRangeId").length ||
            !$("#afterEventTimeId").length ||
            !$("#eventTimeZoneId").length ||
        ...
        if (id != "") {
            if (currentRouteName == "events.edit") {
                if (locationMeta[0] == 1) {
                    ...
                    $("#shortDescLoc").val(
                        locationMeta[1] ? locationMeta[1] : "",
                    );
                    $("#longDescLoc").val(
                        locationMeta[2] ? locationMeta[2] : "",
                    );
