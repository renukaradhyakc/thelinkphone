...
@section('content')
    <div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
        ...
        <a href="#" class="mb-12">
            <img alt="Logo" src="{{ asset(getSettingData()['logo']) }}" class="img-fluid" width="120" height="80" loading="lazy">
        </a>
        ...
        <div class="w-lg-600px bg-white rounded shadow-sm p-10 p-lg-15 mx-auto">
            ...
            <form class="form w-100" method="POST" action="{{ route('register') }}">
                ...
                <!-- Phone Number -->
                <div class="fv-row mb-7">
                    <label class="form-label fw-bolder text-dark fs-6" for="phone_number">Phone Number</label>
                    <div class="input-group">
                        <span class="input-group-text bg-light fw-bold">🇮🇳 +91</span>
                        <input class="form-control form-control-lg form-control-solid" id="phone_number"
                               value="{{ old('phone_number') }}" type="tel" name="phone_number"
                               placeholder="Enter 10-digit mobile number" required autocomplete="off"
